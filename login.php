...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg overflow-hidden animate__animated animate__fadeIn">
            <div class="p-6">
                <h2 class="text-2xl font-bold text-center mb-6">Login to MAQUA Museum</h2>
                ...
                <form action="includes/login.inc.php" method="post" id="login-form" class="space-y-6">
                    <div>
                    ...
                    <div>
                        <button type="submit" name="login-submit" class="w-full btn-primary py-2">
                            Sign in
                        </button>
                    </div>
                </form>
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="register.php" class="font-medium text-primary hover:text-primary-dark">Create an account</a>
                    </p>
                </div>
            </div>
        </div>
